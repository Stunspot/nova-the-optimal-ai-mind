...
Include Free product version 3.1.5, host and operating system, installation source, exact command or request, complete sanitized error, expected result, smallest safe reproduction, and the state that failed: package presence, host discovery, enabled state, restart state, invocation, optional estate configuration, tool availability, or behavior.
