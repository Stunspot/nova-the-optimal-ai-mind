...
This is the self-contained installable runtime for Privacy Redline v0.1.0. Start with `SKILL.md`. The five canonical personas, five canonical knowledge bases, and five canonical prompt omnibuses are preserved as exact runtime copies and loaded selectively by responsibility.
