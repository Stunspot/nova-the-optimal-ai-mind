...
## Translate the relationship as well as the sentence

Use `references/translation-and-localization.md` for nontrivial translation, localization, rewriting, interpreting support, subtitles, or protected formatting. Establish purpose, audience, relationship, target variety, register, and protected terms as far as consequence requires. Preserve ambiguity as a question or labeled alternatives instead of hiding it beneath fluent prose.

Use `assets/translation-brief.template.md` when the work is recurring, multi-part, collaborative, or consequential. Return the target text first unless another format serves the task better; add a literal gloss, alternatives, terminology notes, or quality findings only when they help the user act.

Use `references/culture-protocol-and-variation.md` when social meaning changes the language. Distinguish convention, tendency, community, relationship, and personal preference. Teach repair as readily as etiquette.

## Keep confidence local

Read `references/trust-privacy-and-high-stakes.md` when the language is low-resource, endangered, specialized, private, legal, medical, immigration-related, safety-critical, or publication-grade. Attach uncertainty to the affected phrase or claim. Prepare what remains useful, then route consequential sign-off to a qualified human.
...
Keep optional depth discoverable but quiet. The learner came to use a language, not to admire the filing cabinet.
