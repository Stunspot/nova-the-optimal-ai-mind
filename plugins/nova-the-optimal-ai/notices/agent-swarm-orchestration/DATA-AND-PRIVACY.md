...
Agent Swarm Orchestration 0.3.0 is a local, skills-only Augment. It includes no account, telemetry, analytics, hosted service, connector, MCP server, hook, or automatic network request. Collaborative Dynamics does not receive prompts, files, delegation packets, agent returns, logs, or generated outputs through the plugin.
...
This statement describes the 0.3.0 package as built. Any future connector, hosted service, telemetry, or account-backed edition requires a new privacy review and an updated statement before release.
