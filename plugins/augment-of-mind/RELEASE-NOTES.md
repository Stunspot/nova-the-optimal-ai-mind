...
The patch adds adversarial exact-project versus highly matching global-state coverage and an explicit unrepresented-project degradation. It changes no selector, store owner, workspace schema, Faculty topology, MIND Core runtime, or Faultline contract. MIND 2.2.2 was published as a component of Nova + MIND Free 2.1.2 and is retained unchanged in 2.1.3. Standalone MIND publication is a separate evidence claim; this record establishes product-component publication only.
## 2.2.1
