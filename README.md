...
Codex is the primary integrated release target. The release also includes portable per-skill ZIPs for Claude-compatible skill hosts. If your harness cannot install from an attachment, use the [manual Codex installation](docs/INSTALL-CODEX.md).
