# Free Nova 3.0.0 package map

Free 3.0.0 is one product, one plugin, and one Nova front door.
...
Signal Loom, Ludis Continuum, CanopyOps, and Praxis Mine remain free standalone or opt-in products rather than default weight. Yammerknit requires repair and reseal. OmniView remains an independent provenance decision. Impactful Tom remains excluded from Nova distributions. Dennis Stratton Project Management remains a larger-edition foundation and is not a Free estate dependency.

The package emits a Codex local marketplace, a complete Claude-compatible bundle, twenty-five standalone Claude folders and ZIPs, deterministic host archives, and one complete customer archive. Static parity is not fresh-host evidence.
