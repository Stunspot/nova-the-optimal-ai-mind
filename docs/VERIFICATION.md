...
Nova Free 3.2.0 separates source qualification from final archive construction.
...
After qualification evidence is accepted and committed, confirm that Git reports no tracked or untracked source drift, then run:
    ...
    python -B -X utf8 tools/verify_package.py dist/nova-the-optimal-ai-free-3.2.0
